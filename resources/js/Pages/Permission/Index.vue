                    ...
                    <BCardHeader class="border-0">
                        <div class="d-flex align-items-center">
                            ...
                            <div class="d-flex gap-2">
                                <BButton variant="danger" @click="permissionCreateModal">
                                ...
                                <tbody>
                                    <tr v-for="(permission, i) in resultQuery" :key="i">
                                        ...
                                        <td class="d-flex gap-2">
                                            <BButton variant="success px-3" @click="editModal(permission)">
                                                Edit
                                            </BButton>
                                            <BButton variant="danger px-3" @click="deleteData(permission)">
                                                Delete
                                            </BButton>
                                        </td>
                                    </tr>
