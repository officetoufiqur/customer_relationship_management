            ...
            <ul class="navbar-nav h-100" id="navbar-nav">
                ...
                <li class="nav-item">
                    ...
                    <div class="collapse menu-dropdown" id="sidebarApps">
                        <ul class="nav nav-sm flex-column">
                            <li class="nav-item">
                                <a class="nav-link menu-link" href="#sidebarCalendar" data-bs-toggle="collapse"
                            ...
                            <li class="nav-item">
                                ...
                                <div class="collapse menu-dropdown" id="sidebaremail">
                                    <ul class="nav nav-sm flex-column">
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link" href="#sidebarsubemail" data-bs-toggle="collapse"
                                                role="button" aria-expanded="false" aria-controls="sidebarsubemail"
                                                data-key="t-projects">
                                                {{ $t("t-email-templates") }}
                                            </a>
                                            <div class="collapse menu-dropdown" id="sidebarsubemail">
                                                <ul class="nav nav-sm flex-column">
                                                    <li class="nav-item">
                                                        <Link href="/email/email-basic" class="nav-link"
                                                            data-key="t-products">
                                                        {{
                                                            $t(
                                                                "t-basic-action"
                                                    ...
                                                    <li class="nav-item">
                                                        <Link href="/email/email-ecommerce" class="nav-link"
                                                            data-key="t-products">
                                                        {{
                                                            $t(
                                                                "t-ecommerce-action"
                            ...
                            <li class="nav-item">
                                ...
                                <div class="collapse menu-dropdown" id="sidebarEcommerce">
                                    <ul class="nav nav-sm flex-column">
                                        ...
                                        <li class="nav-item">
                                            <Link href="/ecommerce/product-details" class="nav-link"
                                                data-key="t-product-Details">
                                            {{ $t("t-product-Details") }}
                                            </Link>
                                        </li>
                                        <li class="nav-item">
                                            <Link href="/ecommerce/add-product" class="nav-link"
                                        ...
                                        <li class="nav-item">
                                            <Link href="/ecommerce/order-details" class="nav-link"
                                        ...
                                        <li class="nav-item">
                                            <Link href="/ecommerce/shopping-cart" class="nav-link"
                                        ...
                                        <li class="nav-item">
                                            <Link href="/ecommerce/seller-details" class="nav-link"
                            ...
                            <li class="nav-item">
                                ...
                                <div class="collapse menu-dropdown" id="sidebarProjects">
                                    <ul class="nav nav-sm flex-column">
                                        ...
                                        <li class="nav-item">
                                            <Link href="/apps/projects-create" class="nav-link"
                            ...
                            <li class="nav-item">
                                ...
                                <div class="collapse menu-dropdown" id="sidebarCrypto">
                                    <ul class="nav nav-sm flex-column">
                                        <li class="nav-item">
                                            <Link href="/crypto/transactions" class="nav-link"
                            ...
                            <li class="nav-item">
                                ...
                                <div class="collapse menu-dropdown" id="sidebarTickets">
                                    <ul class="nav nav-sm flex-column">
                                        ...
                                        <li class="nav-item">
                                            <Link href="/apps/tickets-details" class="nav-link"
                            ...
                            <li class="nav-item">
                                ...
                                <div class="collapse menu-dropdown" id="nftmarketplace">
                                    <ul class="nav nav-sm flex-column">
                                        ...
                                        <li class="nav-item">
                                            <Link href="/apps/nft-item-detail" class="nav-link"
                                                data-key="t-ticket-details">
                                            {{ $t("t-item-details") }}
                                            </Link>
                                        </li>
                                        <li class="nav-item">
                                            <Link href="/apps/nft-collection" class="nav-link"
                                                data-key="t-ticket-details">
                                            {{ $t("t-collections") }}
                                            </Link>
                                        </li>
                                        <li class="nav-item">
                                            <Link href="/apps/nft-creators" class="nav-link"
                                                data-key="t-ticket-details">
                                            {{ $t("t-creators") }}
                                            </Link>
                                        </li>
                            ...
                            <li class="nav-item">
                                ...
                                <div class="collapse menu-dropdown" id="jobs">
                                    <ul class="nav nav-sm flex-column">
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link" href="#sidebarjoblist" data-bs-toggle="collapse"
                                                role="button" aria-expanded="false" aria-controls="sidebarjoblist"
                                                data-key="t-projects">
                                                {{ $t("t-job-lists") }}
                                            </a>
                                            <div class="collapse menu-dropdown" id="sidebarjoblist">
                                                <ul class="nav nav-sm flex-column">
                                                    ...
                                                    <li class="nav-item">
                                                        <Link href="/jobs/grid-lists" class="nav-link"
                                                            data-key="t-grid">
                                                        {{ $t("t-grid") }}
                                                        </Link>
                                                    </li>
                                                    <li class="nav-item">
                                                        <Link href="/jobs/details" class="nav-link"
                                                            data-key="t-overview">
                                                        {{
                                                            $t("t-overview")
                                                        }}
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link" href="#sidebarcandidatelists" data-bs-toggle="collapse"
                                                role="button" aria-expanded="false"
                                                aria-controls="sidebarcandidatelists" data-key="t-projects">
                                                {{ $t("t-candidate-lists") }}
                                            </a>
                                            <div class="collapse menu-dropdown" id="sidebarcandidatelists">
                                                <ul class="nav nav-sm flex-column">
                                                    <li class="nav-item">
                                                        <Link href="/jobs/candidate-lists" class="nav-link"
                                                            data-key="t-lists">
                                                        {{
                                                            $t(
                                                                "t-list-view"
                                                    ...
                                                    <li class="nav-item">
                                                        <Link href="/jobs/candidate-grid" class="nav-link"
                                                            data-key="t-grid">
                                                        {{
                                                            $t(
                                                                "t-grid-view"
                                        ...
                                        <li class="nav-item">
                                            <Link href="/jobs/companies-list" class="nav-link"
                ...
                <li class="nav-item">
                    ...
                    <div class="collapse menu-dropdown" id="sidebarAuth">
                        <ul class="nav nav-sm flex-column">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="#sidebarcreatepassword" data-bs-toggle="collapse"
                                    role="button" aria-expanded="false" aria-controls="sidebarcreatepassword"
                        ...
                        <ul class="nav nav-sm flex-column">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="#sidebarBlogs" data-bs-toggle="collapse" role="button"
                                    aria-expanded="false" aria-controls="sidebarBlogs" data-key="t-blogs">{{
                                    $t("t-blogs") }}
                ...
                <li class="nav-item">
                    <a class="nav-link" href="#sidebarlanding" data-bs-toggle="collapse" role="button"
                        ...
                        <BRow>
                            <BCol col lg="4">
                                <ul class="nav nav-sm flex-column">
                                    ...
                                    <li class="nav-item">
                                        <Link href="/ui/buttons" class="nav-link" data-key="t-buttons">{{
                                        $t("t-buttons") }}
                                        </Link>
                                    </li>
                                    <li class="nav-item">
                            ...
                            <BCol col lg="4">
                                <ul class="nav nav-sm flex-column">
                                    ...
                                    <li class="nav-item">
                                        ...
                                        <BBadge variant="success" class="badge-pill" data-key="t-new">{{ $t("t-new") }}
                                        </BBadge>
                                        </Link>
                                    </li>
                                    <li class="nav-item">
                                        <Link href="/ui/general" class="nav-link" data-key="t-general">{{
                                        $t("t-general") }}
                                        </Link>
                                    </li>
                                    <li class="nav-item">
                                        <Link href="/ui/ribbons" class="nav-link" data-key="t-ribbons">{{
                                        $t("t-ribbons") }}
                                        </Link>
                                    </li>
                                    <li class="nav-item">
                            ...
                            <li class="nav-item">
                                ...
                                <div class="collapse menu-dropdown" id="sidebarApexcharts">
                                    <ul class="nav nav-sm flex-column">
                                        ...
                                        <li class="nav-item">
                                            <Link href="/charts/apex-range-area" class="nav-link"
                                                data-key="t-range-area">{{ $t("t-range-area") }}
                                            <BBadge variant="success" class="badge-pill" data-key="t-new">{{ $t("t-new")
                                                }}</BBadge>
                                            </Link>
                                        </li>
                                        ...
                                        <li class="nav-item">
                                            <Link href="/charts/apex-candlestick" class="nav-link"
                                        ...
                                        <li class="nav-item">
                                            <Link href="/charts/apex-polararea" class="nav-link"
                            ...
                            <li class="nav-item">
                                ...
                                <div class="collapse menu-dropdown" id="sidebarAccount">
                                    <ul class="nav nav-sm flex-column">
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link" href="#sidebarlevel" data-bs-toggle="collapse"
                                                role="button" aria-expanded="false" aria-controls="sidebarlevel"
